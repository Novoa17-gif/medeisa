...
const TRADUCCIONES = {
  es: {
    ...
    'cat.mesa-centro-loretta.categoria': 'Mesa de centro · Parota maciza y acero',
    'cat.mesa-centro-loretta.alt':       'Mesa de Centro Loretta: cubierta redonda de parota maciza con veta clara al centro sobre base circular de barras verticales de acero negro, sobre fondo hueso',
  ...
  en: {
    ...
    'cat.mesa-centro-loretta.categoria': 'Coffee table · Solid parota and steel',
    'cat.mesa-centro-loretta.alt':       'Mesa de Centro Loretta: round solid parota top with a light streak through the center on a circular base of vertical black steel bars, on a bone background',
