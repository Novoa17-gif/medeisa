...
const TRADUCCIONES = {
  es: {
    ...
    'hero.alt':       'Centro de TV Monaco de acero negro y madera exhibido solo frente a un muro de yeso hueso con sombras de ventana',
    ...
    'cat.nexo.alt-portada':        'Bufetero Nexo de nogal y acero negro en la galería MEDEISA, con muro de yeso hueso y luz rasante de tarde',
    ...
    'cat.kai.alt-portada':        'Bufetero Kai de encino claro y metal champaña en la galería MEDEISA, con muro de yeso hueso y luz rasante de tarde',
    ...
    'cat.centro-tv-monaco.categoria': 'Centro de TV · Acero y madera',
    ...
    'cat.silla-ap.mensaje':   'Hola, me interesa cotizar la Silla AP de MEDEISA.',
    'cat.centro-tv-loretta.categoria': 'Centro de TV · Acero y parota',
    'cat.centro-tv-loretta.alt':       'Centro de TV Loretta: mueble ovalado de acero negro con barras verticales y repisa central de parota, sobre fondo hueso',
    'cat.centro-tv-loretta.alt-ambiente': 'Centro de TV Loretta con un jarrón de ramas secas encima, en una galería de yeso hueso con sombras de ventana en muro y piso',
    'cat.centro-tv-loretta.mensaje':   'Hola, me interesa cotizar el Centro de TV Loretta de MEDEISA.',
    'cat.mesa-centro-loretta.categoria': 'Mesa de centro · Chapa de madera y acero',
    'cat.mesa-centro-loretta.alt':       'Mesa de Centro Loretta: cubierta redonda de chapa de madera con veta clara al centro sobre base circular de barras verticales de acero negro, sobre fondo hueso',
    'cat.mesa-centro-loretta.alt-ambiente': 'Mesa de Centro Loretta con un jarrón de ramas secas al centro, en una galería de yeso hueso con luz rasante de tarde',
    'cat.mesa-centro-loretta.mensaje':   'Hola, me interesa cotizar la Mesa de Centro Loretta de MEDEISA.',
    'cat.recamara-concepto.categoria': 'Recámara · Chapa de madera y acero',
    'cat.recamara-concepto.alt':       'Recámara Concepto: cama con cabecera de chapa de madera y marco de acero negro con dos óvalos, y un buró a juego, ambos sobre patines de acero negro, sobre fondo hueso',
    'cat.recamara-concepto.alt-ambiente': 'Recámara Concepto con ropa de cama clara y su buró con un jarrón de ramas secas, en una galería de yeso hueso con luz de tarde',
    'cat.recamara-concepto.mensaje':   'Hola, me interesa cotizar la Recámara Concepto de MEDEISA.',
    ...
    'cat.nexo-bufetero.categoria': 'Bufetero · Nogal y acero negro',
    'cat.nexo-bufetero.alt': 'Bufetero Nexo: bufetero largo de nogal con una banda de cajones y listones, cuatro puertas lisas de veta vertical y base de acero negro con travesaños en X, sobre fondo hueso',
    'cat.nexo-bufetero.alt-ambiente': 'Bufetero Nexo en la galería MEDEISA: muro de yeso hueso, luz rasante de tarde y un jarrón con una rama de olivo',
    'cat.nexo-bufetero.mensaje': 'Hola, me interesa cotizar el Bufetero Nexo de MEDEISA.',
    ...
    'cat.kai-bufetero.categoria': 'Bufetero · Encino claro y metal champaña',
    'cat.kai-bufetero.alt': 'Bufetero Kai: bufetero de encino claro con extremos redondeados, dos nichos abiertos y cuatro cajones lisos, sobre patas cónicas de metal champaña, sobre fondo hueso',
    'cat.kai-bufetero.alt-ambiente': 'Bufetero Kai en la galería MEDEISA: muro de yeso hueso, luz rasante de tarde y un jarrón con una rama de olivo',
    'cat.kai-bufetero.mensaje': 'Hola, me interesa cotizar el Bufetero Kai de MEDEISA.',
  ...
  en: {
    ...
    'hero.alt':       'Monaco TV stand in black steel and wood, displayed alone against an off-white plaster wall with window shadows',
    ...
    'cat.nexo.alt-portada':        'Bufetero Nexo in walnut and black steel in the MEDEISA gallery, with an off-white plaster wall and low afternoon light',
    ...
    'cat.kai.alt-portada':        'Bufetero Kai in light oak and champagne metal in the MEDEISA gallery, with an off-white plaster wall and low afternoon light',
    ...
    'cat.centro-tv-monaco.categoria': 'TV console · Steel and wood',
    ...
    'cat.silla-ap.mensaje':   'Hi, I would like a quote for the Silla AP by MEDEISA.',
    'cat.centro-tv-loretta.categoria': 'TV console · Steel and parota',
    'cat.centro-tv-loretta.alt':       'Centro de TV Loretta: oval black steel console with vertical bars and a central parota shelf, on a bone background',
    'cat.centro-tv-loretta.alt-ambiente': 'Centro de TV Loretta with a vase of dried branches on top, in an off-white plaster gallery with window shadows on the wall and floor',
    'cat.centro-tv-loretta.mensaje':   'Hi, I would like a quote for the Centro de TV Loretta by MEDEISA.',
    'cat.mesa-centro-loretta.categoria': 'Coffee table · Wood veneer and steel',
    'cat.mesa-centro-loretta.alt':       'Mesa de Centro Loretta: round wood veneer top with a light streak through the center on a circular base of vertical black steel bars, on a bone background',
    'cat.mesa-centro-loretta.alt-ambiente': 'Mesa de Centro Loretta with a vase of dried branches in the center, in an off-white plaster gallery with low afternoon light',
    'cat.mesa-centro-loretta.mensaje':   'Hi, I would like a quote for the Mesa de Centro Loretta by MEDEISA.',
    'cat.recamara-concepto.categoria': 'Bedroom · Wood veneer and steel',
    'cat.recamara-concepto.alt':       'Recámara Concepto: bed with a wood veneer headboard framed in black steel with two oval outlines, and a matching nightstand, both on black steel sled legs, on a bone background',
    'cat.recamara-concepto.alt-ambiente': 'Recámara Concepto with light bedding and its nightstand holding a vase of dried branches, in an off-white plaster gallery with afternoon light',
    'cat.recamara-concepto.mensaje':   'Hi, I would like a quote for the Recámara Concepto by MEDEISA.',
    ...
    'cat.nexo-bufetero.categoria': 'Sideboard · Walnut and black steel',
    'cat.nexo-bufetero.alt': 'Bufetero Nexo: long walnut sideboard with a band of drawers and slats, four plain vertical-grain doors and a black steel base with X braces, on a bone background',
    'cat.nexo-bufetero.alt-ambiente': 'Bufetero Nexo in the MEDEISA gallery: off-white plaster wall, low afternoon light and a vase with an olive branch',
    'cat.nexo-bufetero.mensaje': 'Hi, I would like a quote for the Bufetero Nexo by MEDEISA.',
    ...
    'cat.kai-bufetero.categoria': 'Sideboard · Light oak and champagne metal',
    'cat.kai-bufetero.alt': 'Bufetero Kai: light oak sideboard with rounded ends, two open niches and four plain drawers, on tapered champagne metal legs, on a bone background',
    'cat.kai-bufetero.alt-ambiente': 'Bufetero Kai in the MEDEISA gallery: off-white plaster wall, low afternoon light and a vase with an olive branch',
    'cat.kai-bufetero.mensaje': 'Hi, I would like a quote for the Bufetero Kai by MEDEISA.',
