...
Convenciones: "frente" = cara con cajones/puertas; conteos siempre en el frente visible. Izquierda/derecha = como se ve en la foto fuente.

## Rasgos comunes

### Kai (roble claro + metal champagne)
- Madera: chapa de roble claro tono miel-naranja (no rojizo, no amarillo limon), veta fina y recta, horizontal en frentes de cajon y cubiertas, vertical en costados de la cama.
- Metal: champagne / oro mate satinado (beige metalico calido, NO dorado brillante, NO laton pulido, NO negro). Regatones negros pequenos en la punta de cada pata.
- Patas: conicas (se adelgazan hacia abajo), redondas, abiertas hacia afuera en diagonal (~15 grados) en ambos ejes, 4 por pieza.
...
- Sin jaladeras metalicas en ninguna pieza.

## Kai

### kai-credenza (kai-01)
- Planta de estadio (rectangulo con extremos semicirculares). Cubierta de estadio que vuela un poco sobre el cuerpo, con un canto sombreado (filete oscuro) entre cubierta y cuerpo.
- Cuerpo: dos columnas laterales cilindricas (medio cilindro) de roble, altura total, en cada extremo; entre ellas el frente plano.
- Frente: arriba 2 nichos abiertos iguales separados por un parante central; abajo 4 cajones lisos en 2 filas x 2 columnas, sin ranura ola (los cajones tienen solo una junta ancha horizontal entre fila superior e inferior).
- Base: 4 patas champagne conicas abiertas + un travesano champagne recto a lo largo del frente, justo bajo los cajones, que une las patas delanteras.
- Proporcion aprox. ancho:alto 2.1:1.

### kai-mesa-redonda (kai-02)
- Cubierta redonda de roble, canto grueso recto (~4 cm), veta horizontal.
- Pedestal "reloj de arena": 8 barras champagne de seccion cuadrada, repartidas en circulo; cada barra sube desde el aro inferior hacia el centro, se quiebra (codo) a ~80% de altura y se abre en V para tocar la cubierta. Cubo central champagne bajo la cubierta.
- Aro inferior de roble macizo (anillo) apoyado en el piso; cada barra lo abraza con una grapa champagne. Regatones negros bajo cada grapa.
- Proporcion ancho:alto aprox. 1.1:1.

### kai-mesa-comedor (kai-05)
- Cubierta ovalada tipo estadio larga (aprox. 3.3:1 en planta), canto recto grueso, roble miel.
- 2 pedestales identicos al de la mesa redonda (barras champagne quebradas + aro de roble abajo), separados, cada uno a ~20% del extremo.

### kai-cama (kai-06) y variante kai-base-cama (kai-03)
- Cabecera: panel de roble alto con esquinas superiores redondeadas y marco perimetral; en la franja superior un cojin tapizado beige crema (tela con dibujo vermicular muy fino tono sobre tono). El borde inferior del tapiz hace la ola Kai: mas bajo a la izquierda, escalon diagonal a ~40% del ancho, mas alto a la derecha; separado de la madera por un filete oscuro.
- Base: marco perimetral de roble con esquinas de pie redondeadas (radio grande), altura de riel ~20 cm; por dentro 2 postes/soportes verticales de roble en la cabecera, un tirante de cuero cafe al centro, escuadras champagne en las esquinas interiores.
- Patas: 4 champagne conicas abiertas en las esquinas; se ven 2 delanteras (y 2 traseras en la base sin cabecera).
- Vista frontal pura (simetrica), sin colchon ni ropa de cama.
- kai-base-cama: la misma base sin cabecera, vista frontal baja.

### kai-comoda (kai-04)
- Caja de roble con esquinas del marco frontal muy redondeadas (las 4), cubierta que envuelve en curva hacia los costados.
- 6 cajones: 2 columnas x 3 filas, separadas por un parante vertical central.
- Ranura ola entre fila 1 y fila 2 en ambas columnas, en espejo: columna izquierda baja a la izquierda y sube hacia el centro (escalon en diagonal a ~60% del ancho de la columna); columna derecha alta junto al centro y baja hacia la derecha (escalon a ~75%). Juntas forman una "meseta" al centro.
- Ranura recta (sin ola) entre fila 2 y fila 3 en ambas columnas.
- Ranura color taupe-bronce, ancho ~2 cm, esquinas redondeadas.
- 4 patas champagne conicas abiertas, regaton negro. Vista 3/4 desde la izquierda.
- Proporcion ancho:alto aprox. 1.9:1 (sin patas ~2.3:1).

### kai-buro (kai-07)
- Caja de roble casi cubica (ancho:alto caja ~1.4:1), esquinas del marco frontal redondeadas, cubierta envolvente.
...
- Cuerpo: 4 puertas lisas iguales sin jaladeras, veta vertical con catedrales.
